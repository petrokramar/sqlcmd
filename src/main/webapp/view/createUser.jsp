...
<body>
    ...
    <div class="container">
        <h2><spring:message code="New.user"/>.</h2><br>
        <form action="adduser" method="post" class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="checkbox col-sm-10">
                    <label><input id="enabled" name="enabled" type="checkbox"><spring:message code="Enabled"/></label>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label" for="btn_add_user"></label>
                <div class="col-sm-10">
                    <button id="btn_add_user" class="btn btn-default"><spring:message code="Create"/></button>
                </div>
            </div>
